...
<!-- form start -->
<form class="form-horizontal" action="<?php echo site_url().'/receipt'?>" method="post">
  <div class="col-lg-6">
    <div class="form-group">
      <label for="inputPassword3"  class="col-sm-2 control-label">User name</label>

      <div class="col-sm-10">
        <input type="text" name="name_receipt" class="form-control" id="inputPassword3" placeholder="User Name">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" name="task_id" class="form-control" id="inputEmail3" placeholder="Task ID">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" name='title' class="form-control" id="inputPassword3" placeholder="Title Task">
      </div>
    </div>
  </div>
  <div class="col-lg-6">
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" name="deadline" class="form-control" id="inputEmail3" placeholder="Deadline ">
      </div>
    </div>
    <div class="form-group">
