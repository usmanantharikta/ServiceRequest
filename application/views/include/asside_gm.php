  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li id="add"><a href="<?php echo site_url().'/manager/add_request'?>"><i class="fa fa-circle-o"></i> Add New Request</a></li>
          <li id="list"><a href="<?php echo site_url().'/manager'?>"><i class="fa fa-circle-o"></i> Request Task List</a></li>
